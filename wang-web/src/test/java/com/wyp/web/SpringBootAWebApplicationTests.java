...
import com.yaping.common.util.CrawlerUtil;
import com.yaping.common.util.FileOutUtils;
import com.yaping.webserver.SpringBootAWebApplication;
...
@SpringBootTest(classes = SpringBootAWebApplication.class)
public class SpringBootAWebApplicationTests {
    ...
    public int crawler(String page) {
        ...
        String url = "http://www.87g.com/index.php?m=content&c=content_ajax&a=picture_page&siteid=1&catid=40&page="
                + page;
